...
int main(int argc, char** argv)
{
    ...
    // Only show error logs so that we can clearly check the mem consumption
    ...
    if (!setUpInference(*iEnv, options.inference, memUsageChecker))
    {
    ...
    memUsageChecker.printMemInfo("Run inferences after setupInference", false);
